window.app = {
    ...
    /* 
    portalIndexUrl: "http://localhost:8080/knowledgeplanet/portal/index.html",           // 门户首页地址
    writerIndexUrl: "http://localhost:8080/knowledgeplanet/writer/contentMng.html",      // 作家中心首页
    writerInfoUrl: "http://localhost:8080/knowledgeplanet/writer/accountInfo.html",     // 用户信息完善页面
    userServerUrl: "http://192.168.1.5:8003",   // 用户服务后端接口地址
    */

    portalIndexUrl: "http://www.knowledgeplanet.art:9090/knowledgeplanet/portal/index.html",           // 门户首页地址
    writerLoginUrl: "http://writer.knowledgeplanet.art:9090/knowledgeplanet/writer/passport.html",      // 登录页面
    writerIndexUrl: "http://writer.knowledgeplanet.art:9090/knowledgeplanet/writer/contentMng.html",      // 作家中心首页
    writerInfoUrl: "http://writer.knowledgeplanet.art:9090/knowledgeplanet/writer/accountInfo.html",     // 用户信息完善页面

    adminCenterUrl: "http://admin.knowledgeplanet.art:9090/knowledgeplanet/admin/contentReview.html",     // 运营管理平台主页
    adminLoginUrl: "http://admin.knowledgeplanet.art:9090/knowledgeplanet/admin/login.html",        // admin后台登录页面
    adminIndexUrl: "http://admin.knowledgeplanet.art:9090/knowledgeplanet/admin/userList.html",        // admin后台默认页面

    userServerUrl: "http://user.knowledgeplanet.art:8003",        // 用户服务后端接口地址
    fsServerUrl: "http://files.knowledgeplanet.art:8004",         // 文件服务后端接口地址
    adminServerUrl: "http://admin.knowledgeplanet.art:8005",      // 运营管理服务后端接口地址
    articleServerUrl: "http://article.knowledgeplanet.art:8001",      // 文章服务后端接口地址

    /**
     * 如果本地使用localhost测试可以不使用，如果是ip或者域名测试，cookieDomain改为对应的ip或者域名
     * 例：
     *    ip：  192.168.1.111
     *    域名：   .knowledgeplanet.com
     */
    cookieDomain: ".knowledgeplanet.art",
